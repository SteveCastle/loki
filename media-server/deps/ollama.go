...
func init() {
	Register(&Dependency{
		...
		LatestVersion: "0.15.0",                      // Version comparison not applicable for API service
		DownloadURL:   "https://ollama.com/download", // Official download page
		ExpectedSize:  0,                             // N/A for API service
		Optional:      true,                          // Ollama is optional
		ManualOnly:    true,                          // Must be installed manually
		InstallURL:    "https://ollama.com/download", // Link for manual installation
	})
}
