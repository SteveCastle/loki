...
// Status constants for download progress reporting.
const (
...
// OverallProgress represents the combined progress of all downloads.
...
// ProgressCallback is a function that receives progress updates during a download.
...
// Update updates the speed tracker with new byte count and returns the
